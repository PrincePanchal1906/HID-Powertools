...
export const HeroSection: React.FC<HeroSectionProps> = ({ initialItems, isAdmin }) => {
  ...
  const HeroInner = (
    <section id="hero-section" className="relative w-full bg-[#f4f5f7] min-h-[520px] max-h-[650px] h-[60vh] lg:h-[90vh] lg:max-h-[900px] flex flex-col overflow-hidden text-gray-900">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[10%] right-[5%] lg:right-[10%] w-[50%] lg:w-[40%] h-[90%] opacity-[0.12] text-[#D42B2B]">
      ...
      {/* Main Container - Strict Horizontal Split (60/40 Mobile, 50/50 Desktop) */}
      <div className="w-full h-full flex flex-row items-center justify-between relative px-[16px] lg:px-[5%] xl:px-[8%] pt-[24px] lg:pt-0 z-10 max-w-[1920px] mx-auto flex-1">
        
        {/* Top Content (Static Brand Statement) */}
        <div className="w-[60%] lg:w-[50%] flex flex-col relative z-20">
          {/* Eyebrow */}
          ...
          {/* CTAs */}
          <div className="flex flex-col lg:flex-row gap-[8px] lg:gap-[16px] w-[140px] sm:w-[180px] lg:w-auto relative z-30">
            <Link 
              href="/products"
        ...
        {/* Fading Images Container (40% Mobile, 50% Desktop) */}
        <div className="relative w-[40%] lg:w-[50%] h-[50%] sm:h-[60%] lg:h-[80%] pointer-events-none z-10 flex items-center justify-end">
            ...
            {images.map((src, idx) => (
              ...
              >
                <Image 
                  ...
                  fill 
                  priority={idx === 0}
                  className="object-contain lg:object-right drop-shadow-[0_10px_15px_rgba(0,0,0,0.1)] lg:drop-shadow-[0_20px_25px_rgba(0,0,0,0.2)] mix-blend-multiply"
